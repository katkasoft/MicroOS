...
void execute_line(string line) {
    ...
    if (arg1_ready && arg2_ready && (arg3_ready || is_arg3_string) && arg4_ready) {
        long return_code;
        if (is_arg3_string) {
        ...
        cerr << "syscall-lang: error: must be four arguments in line" << endl;
    }
}
...
int main(int argc, char* argv[]) {
    if (argc == 2) {
        ...
        if (arg1 == "--help" || arg1 == "help") {
            std::cout << "MicroOS syscall-lang v0.2" << std::endl;
            ...
            std::cout << "  [syscall_number] [arg1] [arg2/\"string\"] [arg3]" << std::endl;
        ...
        cout << "MicroOS syscall-lang v0.2" << endl;
